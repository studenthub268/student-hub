    ...
    <div className="flex flex-col min-h-screen bg-surface text-foreground font-sans">
      ...
      <section className="px-6 sm:px-6 lg:px-8 py-8 sm:py-10 max-w-[1400px] mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-4 min-h-[280px] rounded-[2rem] bg-ink p-6 sm:p-8 flex flex-col justify-between">
            <Skeleton className="h-8 w-24 rounded-full bg-surface/10" />
            <div className="space-y-2">
              <Skeleton className="h-4 w-full bg-surface/10" />
              <Skeleton className="h-4 w-5/6 bg-surface/10" />
              <Skeleton className="h-4 w-2/3 bg-surface/10" />
            </div>
          </div>
          ...
          <div className="lg:col-span-8 min-h-[280px] rounded-[2rem] bg-accent/90 p-8 sm:p-10 flex flex-col justify-between">
            <div className="flex gap-2">
              <Skeleton className="h-7 w-28 rounded-full bg-line" />
              <Skeleton className="h-7 w-24 rounded-full bg-line" />
            </div>
            <div>
              <Skeleton className="h-12 sm:h-20 w-1/2 rounded-2xl bg-line mb-6" />
              <Skeleton className="h-4 w-full max-w-md bg-line" />
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Recent Uploads */}
      <section className="px-4 sm:px-6 lg:px-8 py-12 max-w-[1400px] mx-auto w-full border-t border-line">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="h-64 rounded-[2rem] border-2 border-line p-6 sm:p-8 space-y-4">

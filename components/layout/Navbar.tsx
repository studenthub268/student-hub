      ...
      <div className="flex h-14 items-center justify-between rounded-2xl border border-black/10 bg-white/70 backdrop-blur-xl shadow-[0_8px_30px_rgba(0,0,0,0.08)] px-4 sm:px-6">
        ...
        <div className="flex items-center gap-2">
          {pathname !== "/" && (
            <button
              onClick={() => router.back()}
              className="md:hidden p-2 rounded-xl border border-black/10 bg-white/70 backdrop-blur-md text-black hover:bg-[#0D9488] transition-all press shadow-[0_2px_8px_rgba(0,0,0,0.06)]"
              aria-label="Go back"
            >
        ...
        <div className="flex items-center space-x-3">
          ...
          <button
            ...
            className="md:hidden flex items-center justify-center h-10 w-10 rounded-xl border border-black/10 bg-white/70 backdrop-blur-md text-black hover:bg-[#0D9488] hover:text-black transition-all press shadow-[0_2px_8px_rgba(0,0,0,0.06)]"
